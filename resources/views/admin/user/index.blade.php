            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <span class="d-block m-t-5">Danh sách người dùng</span>
                    </div>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr class="item_user{{ $item_user->id }}">
                                        ...
                                        <td class="col-1"><img src="{{ $item_user->image_path }}" class="img-thumbnail"></td>
                                        <td>
                                            <a href="{{ route('user.edit',['id' => $item_user->id]) }}">
                                                <button type="button" class="btn  btn-primary">Sửa</button>

                                            </a>
                                            <button type="button" class="btn  btn-danger btn_delete-user" data-id="{{ $item_user->id }}" data-url="{{ route('user.delete',['id' => $item_user->id]) }}">Xóa</button>
                                        </td>
                                    </tr>
