                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form action="{{ route('role.update',['id' => $item_role->id]) }}" method="post">
                                        @csrf
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Tên</label>
                                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên" name="name" value="{{ $item_role->name }}">
                                        </div>
                                                    ...
                                                    <div class="card-body row">
                                                        <div class="ml-2 row col-12">
                                                            @foreach ($item_permission_parent->permission as $item_permission)
                                                                <div class="form-check col" >
                                                                    <input type="checkbox" class="form-check-input permission" {{ $item_role->permission->contains('id',$item_permission->id) ? "checked" : "" }} id="exampleCheck1" name="permissions[]" value="{{ $item_permission->id }}">
