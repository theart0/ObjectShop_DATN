...
// more-details end
$("body").append('<div class="fixed-button active"><a href="#top" target="_blank" class="btn btn-md btn-primary"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Top</a> </div>');
